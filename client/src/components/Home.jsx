        ...
        <div className='Home'>
            ...
            <footer>
                ...
                <p className="footer-body">
                    Vidgence is a leading provider of freelance services, connecting talented individuals with clients who need their skills and expertise. From website design and development to writing and marketing, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright Vidgence ©2025| All Rights Reserved
                    </div>
